package com.uday.order.rest.test.integration.controller;

import static com.uday.order.rest.test.util.OrderTestUtils.assertAllButIdsMatchBetweenOrders;
import static com.uday.order.rest.test.util.OrderTestUtils.generateTestOrder;
import static com.uday.order.rest.test.util.OrderTestUtils.generateUpdatedOrder;
import static org.hamcrest.CoreMatchers.equalTo;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.content;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
import static com.uday.order.rest.test.integration.controller.util.OrderControllerTestUtils.*;
...
public class OrderControllerTest extends ControllerIntegrationTest {
    ...
    private ResultActions updateOrder(long id, Order updatedOrder) throws Exception {
    	return put("/orders/{id}", updatedOrder, String.valueOf(id));
    }
